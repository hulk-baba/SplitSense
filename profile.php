     ...
     $sqlr = mysql_query("SELECT * FROM Txn ORDER BY TxnID DESC LIMIT 1");
         if(!$sqlr){
            ...
            // echo nl2br("\r\n");
                    	...
                    	$usr = $userRow['UserID'];
                        $new = mysql_query("SELECT * from EDGE where EDGE.from = $usr ORDER BY weight ASC") or die('failed to fetch table');
                        $cnt = mysql_num_rows($new);
                        $totq = mysql_query(" SELECT SUM(weight) as tot from EDGE where EDGE.from = $usr;");
                        $totr = mysql_fetch_array($totq);
                        $tot = $totr['tot'];
                        if(!$new){
        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                   <img src="https://s.gravatar.com/avatar/f315af528288739ad3f7a4138cb0b508?s=80" alt="..." class="img-rounded">
                    ...
                    <thead>
                        ...
                        echo $str;
                            while ($row = mysql_fetch_array($new)) {
                                ...
                                // echo nl2br("\r\n");
                                $txnid = $row['TxnID'];
                                $dateq = mysql_query("SELECT * from Txn where TxnID = $txnid");
                                $res = mysql_fetch_array($dateq);
                                $date = $res['date'];
                                ...
                                if($f1 and $t1){
                                   echo '
                                    <tbody>
                        <tr>
                            <td class="col-md-4"><em>'. $date.'</em></h4></td>
                        ...
                        if($cnt>0){
                            echo '<tr>
                            <td>   </td>
                            <td class="text-right"><h4><strong>Total Given: </strong></h4></td>
                            <td class="col-md-4 text-center  text-danger"><h4><strong>'.$tot .'</strong></h4></td>
                        </tr>';
                        }
     ...
     $sqlr = mysql_query("SELECT * FROM Txn ORDER BY TxnID DESC LIMIT 1");
         if(!$sqlr){
            ...
            // echo nl2br("\r\n");
                        ...
                        $usr = $userRow['UserID'];
                        $new = mysql_query("SELECT * from EDGE where EDGE.to = $usr ORDER BY weight ASC") or die('failed to fetch table');
                        $cnt = mysql_num_rows($new);
                        $totq = mysql_query(" SELECT SUM(weight) as tot from EDGE where EDGE.to = $usr;");
                        $totr = mysql_fetch_array($totq);
                        $tot = $totr['tot'];
                        if(!$new){
                            echo "failed $new query";
        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            ...
            <div class="row">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>you took on date </th>
                            <th style="text-align: center">Who gave</th>
                            <th class="text-center">What</th>
                            <!-- <th class="text-center">Total</th> -->
                        </tr>
                    </thead>' ;
                        ...
                        <tr>
                            <td class="col-md-4"><em>'. $date.'</em></h4></td>
                            <td class="col-md-4" style="text-align: center">'.$fname .' </td>
                            <td class="col-md-4 text-center">₹' . $val .'</td>
                            <!-- <td class="col-md-1 text-center">$26</td> -->
                        </tr>
                    </tbody> 
                        ...
                        if($cnt>0){
                            echo '<tr>
                            <td>   </td>
                            <td class="text-right"><h4><strong>Total Taken: </strong></h4></td>
                            <td class="col-md-4 text-center  text-danger"><h4><strong>'.$tot .'</strong></h4></td>
                        </tr>';
                        }
                        echo '  </table>
